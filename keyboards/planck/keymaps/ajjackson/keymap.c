 ...
 * |------+------+------+------+------+--------+-------+------+------+------+------+------|
 * | Esc  |   A  |   S  |D/ctrl|   F  |    G   |   H   |   J  |K/ctrl|   L  |   ;  |  "   |
 * |------+------+------+------+------+--------+-------+------+------+------+------+------|
 * |Sft/Rt|   Z  |   X  |   C  |   V  |    B   |   N   |   M  |   ,  |   .  |   /  |Sft/Rt|
 * |------+------+------+------+------+--------+-------+------+------+------+------+------|
 * |  `   | Ctrl | Alt  | GUI  |Lower |Bksp/Alt|Spc/Alt|Raise | Left | Down |  Up  |Right |
 * `---------------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    KC_GRV,         KC_LCTL, KC_LALT, KC_LGUI,      LOWER,   ALT_T(KC_BSPC), ALT_T(KC_SPC),  RAISE,   KC_LEFT,      KC_DOWN, KC_UP,   KC_RGHT
),
